...
<body class="bg-light">
    ...
    <div class="main-container d-flex">
        <!-- ==== sidebar ==== -->
        <!-- ==== full sidebar ==== -->
        <?php $page = "admin"; include "includes/sidebar.php"; ?>
        <!-- ==== end sidebar ==== -->
        <!-- ==== content ==== -->
        <div class="content">
            <!-- ==== navbar ==== -->
            ...
            <div class="container">
                ...
                <div class="d-flex mt-5  justify-content-between">
                    ...
                    <div class="breadcrumb">
                        ...
                        <p class="breadcrumb-item cursor" href="#">Admin Table</p>
                    </div>
                </div>
                <!-- ==== End Title ==== -->
                <!-- ==== add admin row ==== -->
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <!-- <div class="">
                                    <button type="button" name="" id="" class="btn btn-primary btn-lg btn-block"
                                        data-bs-toggle="modal" data-bs-target="#addModal">Write Blog</button>
                                </div> -->
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap border-bottom"
                                        id="responsive-datatable2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">BIO</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Delete & disapprove btn -->
                                                    <button type="button" name="" title="add as admin" id=""
                                                        class="btn btn-primary btn-lg btn-block">
                                                        <i class="fa fa-check" aria-hidden="true"></i>
                                                    </button>
                                                    <!-- Delete & disapprove btn -->
                                                    <button type="button" name="" title="add as super admin" id=""
                                                        class="btn btn-primary btn-lg btn-block">
                ...
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h3 class="card-title">Dismiss Admin</h3>
                                <!-- <div class="">
                                    <button type="button" name="" id="" class="btn btn-primary btn-lg btn-block"
                                        data-bs-toggle="modal" data-bs-target="#addModal">Write Blog</button>
                                </div> -->
