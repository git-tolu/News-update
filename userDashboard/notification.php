...
<body class="bg-light">
    ...
    <div class="main-container d-flex">
        <!-- ==== sidebar ==== -->
        <!-- ==== full sidebar ==== -->
        <?php $page = "notification"; include "includes/sidebar.php"; ?>
        <!-- ==== end sidebar ==== -->
        <!-- ==== content ==== -->
        <div class="content">
            <!-- ==== navbar ==== -->
            ...
            <div class="container">
                ...
                <div class="d-flex mt-5  justify-content-between">
                    ...
                    <div class="breadcrumb">
                        ...
                        <p class="breadcrumb-item cursor" href="#">Notification List</p>
                    </div>
                </div>
                <!-- ==== End Title ==== -->
                <!-- ==== row ==== -->
                <div class="row">
                    <div class="col-md-12">
                        <ul class="notification">
                            <li>
                                <div class="notification-time d-none d-md-block">
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0 d-flex">
                                        <div class="main-avatar avatar-md online">
                                            <img alt="avatar" class="br-7" src="../media/users/21.jpg">
                                        </div>
                                        <div class="media-body ms-3">
                                            <div class=" d-flex justify-content-between">
                                                <div class="">
                                                    <p class="fs-15 text-dark fw-bold mb-0">Dennis Trexy</p>
                                                    <p class="mb-0 fs-13 text-dark">Commented on your post</p>
                                                </div>
                                                <div class="notify-time" role="tab" id="section1HeaderId">
                                                    <p class="mb-0 text-muted fs-11">2 Hrs ago</p>
                                                    <a data-bs-toggle="collapse" href="#section1ContentId"
                                                        aria-expanded="true" aria-controls="section1ContentId">
                                                        <i class="fa fa-angle-double-down float-end pt-2 cursor"
                                                            aria-hidden="true"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div id="section1ContentId" class="collapse in" role="tabpanel"
                                                ...
                                                <div class="mr-5">
                                                    ...
                                                    enim
                                                    eaque ipsum laborum odit quae, numquam sapiente mollitia odio
                                                    repudiandae. Totam, assumenda! Ratione non doloribus omnis ipsam
                                                    enim
                                                    voluptatum iusto.
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <i class="fa fa-times" style="cursor: pointer;" data-bs-dismiss="modal" aria-label="Close"
                                aria-hidden="true"></i>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="blog" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="form-label">Cover image <span
                                                                class="text-red">*</span></label>
                                                        <input type="file" name="blog_media" class="dropify"
                                                            data-bs-height="180" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <textarea name="blog_content" class="editor"
                                                                    id="">Write your blog content here</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div
                                            class="modal-footer text-center justify-content-center d-flex align-items-center">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <textarea name="blog_content" class="editor2"
                                                                    id="">Write your blog content here</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
