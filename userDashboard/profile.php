                                ...
                                <div class="card-body no-padding">
                                    <ul class="list-group no-margin">
                                        ...
                                        <li class="list-group-item d-flex ps-3">
                                            ...
                                            <a href="javascript:void(0)" class="my-auto text-decoration-none"><?php if(!empty($number)){ echo $number; }else{ echo 'Not Yet Provided';} ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="lastname"
                                                    placeholder="Enter Last Name" name="lastname" value="<?= $secondName ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email"
                                            placeholder="Email address" name="email" value="<?= $userEmail ?>">
                                            <span id="emailerr" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputnumber">Contact Number</label>
                                        <input type="number" class="form-control" id="contact"
                                            placeholder="Contact number" name="contact" value="<?= $number ?>">
                                            <span id="contacterr" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">About Me</label>
                                        <textarea class="form-control" rows="6" id="bio" name="bio"><?php if(!empty($bio)){ echo $bio; }else{ echo 'My bio.........';} ?></textarea>
                                        <span id="bioerr" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Date Of Birth</label>
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <select class="form-control select2 form-select" id="date" name="date">
                                                    <option value="<?php if(!empty($date)){ echo $date; }?>"><?php if(!empty($date)){ echo $date; }else{ echo 'Date';}?></option>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <select class="form-control select2 form-select"  id="month" name="month">
                                                    <option value="<?php if(!empty($mon)){ echo $mon; }?>"><?php if(!empty($mon)){ echo $mon; }else{ echo 'Month';}?></option>
                                                ...
                                                <span id="montherr" class="text-primary"></span>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                <select class="form-control select2 form-select" id="year" name="year">
                                                    <option value="<?php if(!empty($year)){ echo $year; }?>"><?php if(!empty($year)){ echo $year; }else{ echo 'Year';}?></option>
                                                ...
                                                <span id="yearerr" class="text-primary"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer text-end">
                                    <button type="submit" id="profileInfoBTN" class="btn btn-primary my-1">Save</button>
