                        ...
                        <div class="card panel-theme">
                            ...
                            <div class="card-body no-padding">
                                <ul class="list-group no-margin">
                                    ...
                                    <li class="list-group-item d-flex ps-3">
                                        <div class="social social-profile-buttons me-2">
                                            <a class="social-icon text-primary text-decoration-none" href="javascript:void(0)"><i class="fa fa-globe"></i></a>
                                        </div>
                                        <a href="javascript:void(0)" class="my-auto text-decoration-none">www.abcd.com</a>
                                    </li>
                                    <li class="list-group-item d-flex ps-3">
                                        <div class="social social-profile-buttons me-2">
                                            <a class="social-icon text-primary text-decoration-none" href="javascript:void(0)"><i class="fa fa-phone"></i></a>
                                        </div>
