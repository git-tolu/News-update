...
<body class="bg-light">
                                ...
                                <div class="text-center chat-image mb-5">
                                    <div class="avatar avatar-xxl chat-profile mb-3 brround">
                                        <a class="" href="profile.html"><img alt="avatar"
                                                src="../media/users/21.jpg" class="brround"></a>
                                    </div>
                                ...
                                <ul class="list-group no-margin">
                                    <li class="list-group-item d-flex ps-3">
                                        <div class="social social-profile-buttons me-2">
                                            <a class="social-icon text-primary text-decoration-none " href="javascript:void(0)">
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        <a href="javascript:void(0)" class="my-auto text-decoration-none">support@demo.com</a>
                                    </li>
                                    <li class="list-group-item d-flex ps-3">
                                        <div class="social social-profile-buttons me-2">
                                            <a class="social-icon text-primary text-decoration-none" href="javascript:void(0)"><i
                                                    class="fa fa-globe"></i></a>
                                        </div>
                                        <a href="javascript:void(0)" class="my-auto text-decoration-none">www.abcd.com</a>
                                    </li>
                                    <li class="list-group-item d-flex ps-3">
                                        <div class="social social-profile-buttons me-2">
                                            <a class="social-icon text-primary text-decoration-none" href="javascript:void(0)"><i
                                        ...
                                        <a href="javascript:void(0)" class="my-auto text-decoration-none">+125 5826 3658</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- <script src="../media/users/21.jpg.js"></script>
    <script src="../media/users/21.jpg.js"></script> -->
    <!-- <script src="../media/users/21.jpg"></script> -->
    <!-- <script src="../media/users/21.jpg.min.js"></script> -->
