                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="">
                                    <button type="button" name="" id="" class="btn btn-primary btn-lg btn-block" data-bs-toggle="modal" data-bs-target="#addModal">Write Blog</button>
                                </div>
                            </div>
                            <div class="card-body">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <i class="fa fa-times" style="cursor: pointer;" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></i>
